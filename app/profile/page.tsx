      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-card border border-border rounded-lg p-8">
          ...
          <div className="mb-8 p-6 bg-primary/10 border border-primary/20 rounded-lg">
            ...
            <p className="text-3xl font-bold text-primary">{profileData?.ecoPoints || 0}</p>
            <p className="text-sm text-muted-foreground mt-2">Earned from donations and successful requests</p>
          </div>
